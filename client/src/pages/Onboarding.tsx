      ...
      <div className="min-h-screen bg-t1-bg transition-colors duration-200">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex items-start gap-4 mb-8">
            <div
              className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 ${modComplete ? "bg-emerald-500/20" : "bg-t1-accent/20"}`}
            >
              <Icon
          ...
          {onboardingModules.map(mod => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${modComplete ? "bg-emerald-500/20" : "bg-t1-accent/20"}`}
                  >
                    <Icon
