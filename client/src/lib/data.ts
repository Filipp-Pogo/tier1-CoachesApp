...
export type SkillCategory = 'baseline' | 'transition' | 'serve-return' | 'movement' | 'doubles' | 'tactical' | 'physical' | 'mental' | 'return' | 'serve-plus-one' | 'return-plus-one' | 'defense' | 'attacking' | 'baseline-pattern' | 'point-play' | 'pressure-match-prep';
